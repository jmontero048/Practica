...
{
    public class AsadaPajaController : SscController
    {
        private readonly HttpClient cliente;

        public AsadaPajaController()
        {
        ...
        [HttpGet]
        public async Task<ActionResult> ListadoAsadaPajas(int codigoOrganizacion = 0, int codigoCompania = 0, int codigoPaja = 0, int codigoEstado = 0)
        {
