...
{
    public class AsadaSaldoAFavorController : SscController
    {
        private readonly HttpClient cliente;

        public AsadaSaldoAFavorController()
        {
            cliente = ClienteApi.Initialize();
        }

        #region AsadaSaldoAFavor
        //recuperar los datos del listado general 
        [HttpGet]
        public async Task<ActionResult> ListadoAsadaSaldosAFavor(int codigoOrganizacion = 0, int codigoCompania = 0, int codigoPaja = 0, int codigoEstado = 0)
        {
