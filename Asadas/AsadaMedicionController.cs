...
{
    public class AsadaMedicionController : SscController
    {
        private readonly HttpClient cliente;

        public AsadaMedicionController()
        {
            cliente = ClienteApi.Initialize();
        }

        #region AsadaMedicion
        //recuperar los datos del listado general 
        [HttpGet]
        public async Task<ActionResult> ListadoAsadaRMLs(int codigoOrganizacion = 0, int codigoCompania = 0, int codigoPaja = 0, int codigoEstado = 0)
        {
