...
{
    public class AsadaMultaController : SscController
    {
        private readonly HttpClient cliente;

        public AsadaMultaController()
        {
        ...
        [HttpGet]
        public async Task<ActionResult> ListadoAsadaMultas(int codigoOrganizacion = 0, int codigoCompania = 0, int codigoPaja = 0, int codigoEstado = 0)
        {
