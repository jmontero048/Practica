...
{
    public class AsadaPagoController : SscController
    {
        private readonly HttpClient cliente;

        public AsadaPagoController()
        {
        ...
        [HttpGet]
        public async Task<ActionResult> ListadoAsadaPagos(int codigoOrganizacion = 0, int codigoCompania = 0, int codigoPaja = 0, int codigoEstado = 0)
        {
