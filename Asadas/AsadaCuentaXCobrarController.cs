...
{
    public class AsadaCuentaXCobrarController : SscController
    {
        private readonly HttpClient cliente;

        public AsadaCuentaXCobrarController()
        {
            cliente = ClienteApi.Initialize();
        }

        #region AsadaCuentaXCobrar
        //recuperar los datos del listado general 
        [HttpGet]
        public async Task<ActionResult> ListadoAsadaCuentasXCobrar(int codigoOrganizacion = 0, int codigoCompania = 0, int codigoPaja = 0, int codigoEstado = 0)
        {
