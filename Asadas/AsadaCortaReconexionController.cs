...
{
    public class AsadaCortaReconexionController : SscController
    {
        private readonly HttpClient cliente;

        public AsadaCortaReconexionController()
        {
            cliente = ClienteApi.Initialize();
        }

        #region AsadaCortaReconexion
        //recuperar los datos del listado general 
        [HttpGet]
        public async Task<ActionResult> ListadoAsadaCortasyReconexiones(int codigoOrganizacion = 0, int codigoCompania = 0, int codigoPaja = 0, int codigoEstado = 0)
        {
        ...
        #endregion AsadaCortaReconexion
    }
}
